...
### 📋 목차
<ul>
      <li><a href="#1.-알쓸거래(알고보니-쓸모있고-유익한-거래)-플랫폼">1. 알쓸거래(알고보니 쓸모있고 유익한 거래) 플랫폼</a></li>
      <li><a href="#2.-파뿌리(시니어-AI-음성케어)-플랫폼">2. 파뿌리(시니어 AI 음성케어) 플랫폼</a></li> 
      <li><a href="#3.-버블버블(AI-법률지식)-서비스">3. 버블버블(AI 법률지식) 서비스</a></li> 
</ul>
